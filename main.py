...
def main():
    ...
    r2_backet_name = params["cloudflare"]["r2"]["backet_name"]
    ...
    plot_charts(daily_stock_df, new_highs_list, charts_output_dir)
    ...
    Path_report_template = "./input/report_templates"
    file_name_report_template = "new_high_report.html"
    
    Path_output_report_html = f"./output/reports/new_high_report_{newest_market_date}.html"
    Path_output_report_pdf = f"./output/reports/new_high_report_{newest_market_date}.pdf"
    ...
    send_report_to_LINE(new_highs_df, 
        newest_market_date, 
        report_url, 
